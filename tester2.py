...
'''
users = [
   ('00001','Melonie','Runz', 'female'),
   ('00002','Eric', 'Ironheart', 'male'),
   ('00003', 'Marion', 'Sunrose', 'male'),
   ('00004', 'Amely', 'Sunrose', 'female'),
   ('00005', 'Michael', 'Fersan', 'male')
]

cur.executemany("""INSERT INTO users VALUES(?,?,?,?);""", users)

customers = [
  ('00006', 'Roman', 'Sentar', 'male'), ('00007', 'Irya', 'Kellington', 'non-binary'), 
